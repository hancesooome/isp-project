...
export function TechnicianWorkQueuePage() {
  ...
  return <div className="min-h-screen bg-[radial-gradient(circle_at_top_right,rgba(71,118,255,0.09),transparent_28%),#0a0d12] text-slate-100">
    <header className="sticky top-0 z-10 border-b border-white/8 bg-[rgba(10,13,18,0.82)] shadow-[0_8px_24px_rgba(0,0,0,0.12)] backdrop-blur-xl"><div className="mx-auto flex min-h-16 max-w-4xl items-center justify-between gap-4 px-4 py-2 sm:px-6"><div className="flex items-center gap-3"><Link aria-label="Conek home" className="inline-flex rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400" to="/technician"><BrandLogo className="h-9 w-auto max-w-32" inverse /></Link><span className="hidden border-l border-white/10 pl-3 text-xs font-medium text-slate-500 sm:block">Field operations</span></div><button className="min-h-11 rounded-[9px] px-3 text-sm font-medium text-slate-300 transition hover:bg-white/8 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400" onClick={() => void signOut()} type="button">Sign out</button></div></header>
