  ...
  return (
    <header className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
      <div className="max-w-2xl">
        ...
        <h1 className={`${eyebrow ? 'mt-2' : ''} scroll-mt-24 break-words text-3xl font-semibold tracking-[-0.035em] text-slate-950 outline-none sm:text-4xl`} ref={titleRef} tabIndex={titleTabIndex}>{title}</h1>
