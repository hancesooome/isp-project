        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-[1.45fr_0.8fr]">
          {subscription.status === 'suspended' ? (
            <div className="rounded-[12px] border border-red-200 bg-red-50 p-5 text-sm leading-6 text-red-900 lg:col-span-2" role="alert">
              <p className="font-semibold">Your account service is currently suspended.</p>
              <p className="mt-1">Review your email for the reason and next steps, or contact support for help. This is an operational account status and does not confirm the state of your physical internet connection.</p>
              <Link className="mt-3 inline-flex min-h-10 items-center font-semibold text-red-800 underline decoration-red-300 underline-offset-4" to="/account/support">Contact support</Link>
            </div>
          ) : null}
